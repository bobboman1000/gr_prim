...
exp_man.add_experiment(ex_data, DummyGenerator(), DummyMetaModel(), c.discovery_algs["prim"], name="dummy_dummy_prim_clean2", new_samples=2500, fragment_limit=1, enable_probabilities=True, scaling=ZERO_ONE_SCALING)
exp_man.add_experiment(ex_data, c.generators["munge1"], c.metamodels["classRF"], c.discovery_algs["prim"], name="kde-si_classRF_prim_clean2", new_samples=2500, fragment_limit=1, enable_probabilities=True, scaling=Z_SCORE_SCALING)
